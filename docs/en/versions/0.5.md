...
See the [language specification](/spec/language-spec), [interfaces](/language/interfaces), [enums and switch](/language/enum-switch), and [generics](/language/generics) for the complete rules.

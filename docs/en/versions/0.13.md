...
See the [Annotation specification](/spec/annotations), [Annotation grammar](/spec/grammar/annotations), [Validation API](/stdlib/validation-api), and [Reflect](/language/reflect) for the complete rules.

...
- Manifests, paths, and package headers determine project topology; body diagnostics do not change the module source set while editing.
...
- Artifact identity covers Core groups, the entry occurrence, namespace/interface identity, binding occurrences, source content, origins, reference routes, and the backend ABI.

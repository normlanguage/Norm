...
<section class="norm-intro norm-section">
  ...
  <div class="norm-feature-grid">
    ...
    <article><span class="norm-feature-number">03</span><h3>Reified generics</h3><p>Actual type arguments enter Core IR and the runtime type environment without erasure or an extra type token.</p></article>
  </div>
</section>
...
<section class="norm-section norm-syntax-section">
  ...
  <div class="norm-showcase-grid">
    ...
    <article><div><span>Reified generics</span><h3>Generic arguments survive at runtime.</h3><p>The compiler writes complete arguments into Core IR and the runtime type environment.</p><a href="./language/generics">Read about generics →</a></div><pre><code v-pre>List&lt;String&gt; names = List&lt;&gt;()&#10;List&lt;Integer&gt; counts = List&lt;&gt;()</code></pre></article>
  </div>
</section>

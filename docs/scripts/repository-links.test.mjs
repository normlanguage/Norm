...
test('repository source links resolve before rendering while site links stay local', () => {
  ...
  const html = md.render('[source](../../cli/compiler/pom.xml#L1) [folder](../../cli/compiler/scripts/) [page](../index.md) [external](https://example.com)', env)
  assert.ok(html.includes('https://github.com/normlanguage/Norm/blob/main/cli/compiler/pom.xml#L1'))

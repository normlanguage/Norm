...
public final class VirtualDocumentUri {
  public static final String SCHEME = "norm-source";

  private VirtualDocumentUri() {}

  public static String encode(DocumentId document) {
    String identity =
  ...
  public static Optional<DocumentId> decode(String value) {
    try {

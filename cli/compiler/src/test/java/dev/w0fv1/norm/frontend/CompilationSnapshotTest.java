...
final class CompilationSnapshotTest {
  ...
  void analyzesMultiplePreludeSourceOverlaysInOneSemanticSnapshot() {
    ...
    SourceFile first = SourceFile.of(firstDocument, "package std Integer first() { return 1 }");
    SourceFile second = SourceFile.of(secondDocument, "package std Integer second() { return 2 }");
    CompilationPrelude prelude =
        new CompilationPrelude(
